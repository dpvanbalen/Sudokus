...
/* package sudokuAccelerateStack-0.1.0.0 */
#ifndef VERSION_sudokuAccelerateStack
#define VERSION_sudokuAccelerateStack "0.1.0.0"
#endif /* VERSION_sudokuAccelerateStack */
#ifndef MIN_VERSION_sudokuAccelerateStack
#define MIN_VERSION_sudokuAccelerateStack(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sudokuAccelerateStack */
...
/* package accelerate-llvm-1.2.0.1 */
#ifndef VERSION_accelerate_llvm
#define VERSION_accelerate_llvm "1.2.0.1"
...
/* package cuda-0.10.1.0 */
#ifndef VERSION_cuda
#define VERSION_cuda "0.10.1.0"
#endif /* VERSION_cuda */
...
/* package lens-accelerate-0.2.0.0 */
#ifndef VERSION_lens_accelerate
#define VERSION_lens_accelerate "0.2.0.0"
#endif /* VERSION_lens_accelerate */
#ifndef MIN_VERSION_lens_accelerate
#define MIN_VERSION_lens_accelerate(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_lens_accelerate */

/* package llvm-hs-8.0.0 */
#ifndef VERSION_llvm_hs
#define VERSION_llvm_hs "8.0.0"
...
/* package llvm-hs-pure-8.0.0 */
#ifndef VERSION_llvm_hs_pure
#define VERSION_llvm_hs_pure "8.0.0"
...
#define CURRENT_COMPONENT_ID "sudokuAccelerateStack-0.1.0.0-FJBRyYl4bh2KEeHpHr9wCp-sudokuAccelerateStack"
